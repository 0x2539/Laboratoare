<%@ Page Language="C#" MasterPageFile="~/MasterPageMaster.master" AutoEventWireup="true" CodeFile="Photo.aspx.cs" Inherits="Photo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id='content'>
        ...
        <form id="form1" runat="server">
            ...
            <textarea id="commentTextArea" runat="server" visible='<%# canAddComment() %>' name="message" rows="5" cols="70"></textarea>
            <br />
        ...
        <div>
            ...
            <asp:Repeater ID="Repeater1" runat="server" DataSourceID="XDSComment">
                <ItemTemplate>
                    <div style="display: block; width: auto;" datasource='<%# XPathSelect("Comment") %>'>

                        <a href='<%# "/MyProfile.aspx?userId=" + XPath("@Id") %>'>
                            <div id='user'><%#getUsernameById(XPath("@user").ToString())%></div>
                        </a>
                        ...
                        <div class="dialogbox">
                            <div class="body">
                                ...
                                <asp:HyperLink ID="HyperLink1" Visible='<%# canDeleteComment(XPath("@user").ToString()) %>' NavigateUrl='<%# "~/DeleteComment.aspx?commentId=" + XPath("@Id") %>' runat="server" Style="clear:both;float: right; margin: 10px; display: inline-block;">Delete</asp:HyperLink>
                            </div>
                        </div>
